...
import 'package:tictok_clone2/models/user.dart' as model;
import 'package:tictok_clone2/views/screens/auth/login_screen.dart';
import 'package:tictok_clone2/views/screens/home_screen.dart';
  ...
  void loginUser(
    ...
    try {
      if (email.isNotEmpty && password.isNotEmpty) {
        ...
        Get.snackbar("Error Logging in  Account",
            'Please enter all the fields');
      }
    } catch (e) {
